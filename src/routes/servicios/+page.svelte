    ...
    <div class="flex flex-col md:flex-row ">
        ...
        <article class="border border-zinc-900 rounded-2xl flex flex-col md:flex-row m-4 md:w-1/2">
            ...
            <div class="m-8">
                ...
                <p class="mt-4 text-xl">Desde el diseño hasta el desarrollo, estoy aquí para hacer brillar tu presencia en línea.</p>
            </div>
        </article>
    </div>
</section>
...
<!--ir al Form Contacto-->
<section class="flex flex-col  md:flex-row justify-evenly items-center w-full md:py-16 px-8 md:px-16">
...
<section class="max-w-screen-xl mx-auto my-20 ">
    <div>
        <p class="text-center w-[400px] m-auto">Estas son las etapas de mi trabajo </p>
    ...
    <div class="flex flex-col md:flex-row ">
        ...
        <article class="border border-zinc-900 rounded-2xl flex flex-col m-4 bg-[#FFF5E8] w-11/12 md:w-1/4 ">
            ...
            <div class="m-4 md:ml-8">
                ...
                <p class="mt-4">Revisamos y ajustamos cada detalle para que el resultado sea lo que estabas soñando.</p>
            </div>
        </article>
    </div>
</section>