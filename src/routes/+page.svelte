...
<section class="bg-[#FFF5E8] my-8">
  ...
  <div class="flex flex-row justify-evenly items-center w-full relative overflow-hidden  pb-10">
    <img
      width="200"
...
<!--Servicios-->
<section class="flex flex-col  md:flex-row justify-evenly items-center w-full bg-[#F1F0FE] py-16 px-16">
  <!--CTA Form-->
  <div class="flex flex-col justify-items-center md:w-1/2">
    <h2 class="text-2xl text-center md:text-left">Dale a tu proyecto el valor que se merece</h2>
    <p class="my-4 text-center md:text-left"> Te ayudo a potenciar tu desarrollo en el mundo digital </p>
    <Button class="w-max">Necesitas ayuda?</Button>
  </div>
  <!--Ilustraciones-->
  <div class="flex flex-col md:flex-row justify-center  justify-items-center md:justify-between w-full md:w-1/2 md:items-end">
    <article class="justify-items-centermt-4">
      <figure class=" w-[140px] mt-8 m-auto md:w-[120px]">
        <img alt="ilustracion pantalla de diseño" src="/img-home/colaboracion.png" />
      </figure>
      <h3 class="w-[120px] text-center mx-auto mt-4"> Creamos en colaboración </h3>
    </article>
    <article>
      <figure  class=" w-[140px] mt-8 m-auto md:w-[120px]">
        <img alt="ilustracion diseño responsivo" src="/img-home/responsive.png" />
      </figure>
      <h3 class="w-[120px] text-center mx-auto  mt-4"> Diseño web Responsivo </h3>
    </article>
    <article>
      <figure  class=" w-[140px] mt-8 m-auto md:w-[120px]">
        <img alt="ilustracion pantalla de diseño" src="/img-home/personalizado.png" />
      </figure>
      <h3 class="w-[120px] text-center mx-auto  mt-4"> Sin plantillas y a tu medida </h3>
    </article>
  </div>
