...
<section class=" w-screen">
    ...
    >
      ...
      <div class="md:w-1/2 text-left space-y-6  md:ml-16 md:pl-10">
        ...
        <p class="w-full md:w-3/4">
            ...
            soy súper autoexigente y veo cada proyecto como una nueva oportunidad para superar 
            mis propios límites.
        </p>
        <p class="w-full md:w-3/4">
            Mi enfoque en el diseño web se basa en la estética visual y la creatividad, me encanta 
            explorar las posibilidades de combinar colores, formas y elementos para crear experiencias 
            únicas y que transmitan la mejor energía, muchas veces siento que el término que mejor 
            me define es artista digital, ya que la mayor inspiración para mi son las infinitas 
            técnicas y estilos del arte y me siento una privilegiada en poder expresarlo a través 
            de mi trabajo. 
        </p>
        <p class="w-full md:w-3/4">
            Si estás buscando una visión fresca e innovadora para tu presencia en línea, estaré 
            encantada de colaborar contigo y crear una experiencia digital que destaque y conecte 
            con tu audiencia de una manera única.
        </p>
      </div>
    </div>
  </section>
    ...
    >
      <div class="md:w-1/2 text-left space-y-6  md:mt-[120px] md:ml-16">
        ...
        <p class="w-full md:w-3/4 pb-28  ">
            ...
            fascina. Busco incorporar esa misma esencia en mis diseños web, creando interfaces que 
            no solo sean visualmente atractivas, sino que también reflejen la individualidad de 
            cada marca y su mensaje, así como en la danza encuentro la importancia del equilibrio, 
            la fluidez y la armonía, cualidades que intento transmitir en cada aspecto de mi trabajo.
        </p>
      </div>
      <figure>
        <img class="w-4/5" alt="foto de paly en la playa" src="/img-acerca/universo-paralelo.png" />
      </figure>
    </div>
  </section>
  <section class="bg-[#F1F0FE] py-10 mx-auto">
    ...
    <div class="flex flex-col md:flex-row justify-between mt-10 md:w-11/12 mx-auto">
        <!--Pelicula-->
